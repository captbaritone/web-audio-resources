...
- [Winamp2-js](https://jordaneldredge.com/projects/winamp2-js/) - A reimplementation of Winamp 2.9 using the Web Audio API. 9[GitHub](https://github.com/captbaritone/winamp2-js)
